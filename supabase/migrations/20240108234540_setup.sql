...
AS $$
DECLARE
  project_url TEXT := 'https://mjlmrawcqjshdivwvczr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1qbG1yYXdjcWpzaGRpdnd2Y3pyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MDYyNjcyNywiZXhwIjoyMDY2MjAyNzI3fQ.mYshyCGkIWXVu8GIcEQLY0zP4MTwhkMUVKWEzo2vZrM'; -- full access needed for http request to storage
