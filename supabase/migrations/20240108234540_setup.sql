...
AS $$
DECLARE
  project_url TEXT := 'https://zvwztcappccftfeajfwf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp2d3p0Y2FwcGNjZnRmZWFqZndmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MTc5MjMwNSwiZXhwIjoyMDY3MzY4MzA1fQ.gb1ODPWunnFmNbBHl3fl1rHHYKMGinhIu-z8qv5m4NQ'; -- full access needed for http request to storage
